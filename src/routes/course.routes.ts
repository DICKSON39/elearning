...
import { CreateCourse, deleteCourse, getAllCourse, getAllCourseTeacher, getCoursesById, updateCourse } from "../controllers/corsesController";
...
router.put('/courses/:id',protect,AdminOrTeacher,upload.single('image'),updateCourse)
