...
export const roleGuard = (allowedRoles: string[]) => {
  return asyncHandler(async (req: RoleRequest, res: Response, next: NextFunction) => {
...
export const AdminOrUser = (req: UserRequest, res: Response, next: NextFunction) => {
...
// roleMiddleware.ts
export const AdminOrTeacher = (req: UserRequest, res: Response, next: NextFunction) => {
